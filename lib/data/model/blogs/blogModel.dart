...
class BlogModel {
  ...
  final List<BlogTag> translatedTags;
  ...
  BlogModel.fromJson(Map<String, dynamic> json)
      : id = json['id']?.toString() ?? '',
        ...
        translatedDescription = (json['translated_description']?.toString() ?? '').isNotEmpty
            ? json['translated_description']!.toString()
            : (json['description']?.toString() ?? ''),
        createdAt = json['created_at']?.toString() ?? '',
        updatedAt = json['updated_at']?.toString() ?? '',
        categoryName = json['description']?.toString() ?? '',
        translatedCategoryName = (json['translated_category_name']?.toString() ?? '').isNotEmpty
        ...
        tags = (json['tags'] as List?)
            ...
            .toList() ??
            [],
        translatedTags = ((json['translated_tags'] ?? json['tags']) as List?)
            ?.map((tag) => BlogTag.fromJson(Map<String, dynamic>.from(tag)))
            .toList() ??
            [];
  ...
  Map<String, dynamic> toJson() => {
        ...
        'translated_tags': translatedTags.map((tag) => tag.toJson()).toList(),
      };
}
