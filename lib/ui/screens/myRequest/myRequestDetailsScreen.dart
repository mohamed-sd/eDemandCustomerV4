...
class ServiceDetailsScreen extends StatefulWidget {
  const ServiceDetailsScreen({
    ...
    required this.status, required this.translatedStatus,
  }) : super(key: key);
          ...
          appBar: UiUtils.getSimpleAppBar(
              ...
              actions: [
                _buildCustomStatusContainer(
                    status: widget.status, context: context,translatedStatus:widget.translatedStatus ),
              ]),
  ...
  Widget _buildAvailableProviders(
      ...
      Column(
        ...
        children: [
                                ...
                                onPressed: () {
                                  Navigator.pushNamed(
                                    ...
                                    arguments: {
                                      ...
                                      "providerName": bidder.translatedProviderName,
          ...
          SizedBox(
            height: kBottomNavigationBarHeight.rh(context),
          ),
        ],
      );
  ...
  Widget _buildCategoryContainer(
    ...
    return CustomContainer(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            flex: ResponsiveHelper.isLargeTablet(context) ||
