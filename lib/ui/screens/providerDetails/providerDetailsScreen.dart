...
// _scrollController fetches the next paginated data when the current position of the user on the screen has surpassed
          ...
          builder: (final BuildContext context, final CartState state) =>
            ...
            builder: (final context, final state) {
              if (state is ProviderDetailsAndServiceFetchFailure) {
                ...
                final double scrollThreshold = hasPromoCode ? 250 : 150;
                      ...
                      headerSliverBuilder: (final BuildContext context,
                        ...
                        SliverLayoutBuilder(
                          builder: (context, constraints) {
                            return SliverAppBar(
                              title: constraints.scrollOffset >= scrollThreshold
                                  ? CustomText(
  ...
  Future<void> _handleShareButtonClick(
    ...
    final String shareURL =
        'https://$domain/provider-details/${providerDetails.slug}?lat=${HiveRepository.getLatitude}&lon=${HiveRepository.getLongitude}&lang=${HiveRepository.getCurrentLanguage()!.languageCode}&share=true';
    await UiUtils.share(
      context: context,
      shareURL,
